  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black flex flex-col">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between p-4 bg-gradient-to-b from-black/70 to-transparent">
        <button
          onClick={handleClose}
          className="flex items-center gap-2 text-white font-semibold text-sm bg-black/30 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-black/50 transition"
        >
        ...
        <div className="text-white text-center flex-1 px-4">
          <p className="text-sm font-bold truncate">{glass.name}</p>
          <p className="text-xs text-white/80">{priceText}</p>
        </div>
